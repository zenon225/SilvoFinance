  ...
  const features = [
    {
      ...
      description:
        "Vos investissements sont protégés par des protocoles de sécurité de niveau bancaire et des assurances complètes.",
    },
    {
      icon: TrendingUp,
      title: "Rendements Exceptionnels",
      description:
        "Notre nouvelle formule génère 2,5% de rendement quotidien garanti pendant 40 jours, doublant votre capital.",
    },
    {
      icon: Award,
      title: "Expertise Reconnue",
      description:
        "Une équipe de gestionnaires certifiés avec plus de 20 ans d'expérience sur les marchés financiers.",
    },
    {
      icon: Users,
      title: "Support Dédié",
      description:
        "Un conseiller personnel vous accompagne tout au long de votre parcours d'investissement.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 slide-up">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Pourquoi Choisir{" "}
            <span className="gradient-text">Silvo Finance</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Nous combinons innovation technologique et expertise financière pour
            offrir 2,5% de rendement quotidien garanti en FCFA avec des gains
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="slide-up">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Chez Silvo Finance, nous croyons que chacun mérite d'accéder aux
              meilleures opportunités d'investissement. Notre approche
              révolutionnaire vous permet de doubler votre capital en seulement
              40 jours avec 2,5% de gains quotidiens.
            </p>
            <ul className="space-y-4 mb-8">
              {[
                "Rendement garanti de 2,5% et plus par jour pendant 40 jours",
